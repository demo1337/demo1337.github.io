...
$("#submit_now").click(function(){
	...
	var total = (+att1)+(+att2)+(+att3)+(+att4)+(+att5)+(+att6)+(+att7)+(+att8)+(+att9)+(+att10);
	if(total <= 10){
		priority = "Low";
	...
	$("#output_table").append("<tr><th>"+priority+"</th><th>"+input+"</th><td>"+att1+"</td><td>"+att2+"</td><td>"+att3+"</td><td>"+att4+"</td><td>"+att5+"</td><td>"+att6+"</td><td>"+att7+"</td><td>"+att8+"</td><td>"+att9+"</td><td>"+att10+"</td><td>"+total+"</td></tr>");
}
});
};